...
// Build SQL query
$sql = "SELECT runs.id, runs.username, runs.route,runs.checkpoints,runs.activity_type, runs.total_distance,runs.start_time, TIMESTAMPDIFF(SECOND, runs.start_time, runs.end_time) AS total_time
        FROM runs
